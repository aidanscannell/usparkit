...
@section('content')
  ...
  <!-- page-title start -->
	<section class="main-container border-clear light-gray-bg padding-bottom-clear">
  	<div class="container">
  		<h2 class="page-title text-center"><strong>Privacy Policy </strong></h2>
  		<!-- page-title end -->

			<div class="row">
				<div class="col-lg-12 col-sm-12"
					<p>Last updated: August 2, 2016</p>

					<p>uSparkit (“us”, “we”, or “our”) operates the https://www.usparkit.com website (the “Service”).</p>

					<p>This page informs you of our policies regarding the collection, use and disclosure of Personal Information when you use our Service.</p>

					<p>We will not use or share your information with anyone except as described in this Privacy Policy.</p>

					<p>We use your Personal Information for providing and improving the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at https://www.usparkit.com </p>
